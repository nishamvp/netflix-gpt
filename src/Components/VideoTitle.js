...
const VideoTitle = ({ title, overview }) => {
  return (
      ...
      <div className="absolute pl-[6%] pt-[20%] text-white  bg-gradient-to-r from-black  w-screen aspect-video">
        ...
        <p className="w-1/3 text-lg font-semibold opacity-60">{overview}</p>
        <div className="flex gap-3 mt-5 opacity-80">
          <div className="flex items-center justify-center px-10 text-black bg-white py-2 rounded-md gap-1 ">
            <PlayIcon />
            <button className="text-md font-bold">Play</button>
          </div>
          <div className="flex items-center justify-center px-10 bg-gray-700 py-2 rounded-md gap-1 ">
            <InfoIcon />
